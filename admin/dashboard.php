...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="brand-box">
            ...
            <img src="<?php echo url('/assets/'); ?>logo_parfum_bk.png" alt="Logo" onerror="this.src='https://placehold.co/80x80?text=Logo';">
            <h4>PARFY.ID</h4>
        </div>

        <!-- Container Menu Utama -->
        <div class="menu-container">
            <a href="<?php echo url('/admin/dashboard'); ?>" class="menu-item active">
                <i class="bi bi-grid"></i> Dashboard
            </a>
            <a href="<?php echo url('/admin/produk'); ?>" class="menu-item">
